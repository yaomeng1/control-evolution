...
def process(b, edge_list_ini, adj_dict_ini):
...
if __name__ == "__main__":
    ...
    file = "./efficient_decentralized_controlrate_5_tit_tat.pk"
    if not os.path.exists(file):
        os.mknod(file)
    with open('./efficient_decentralized_controlrate_5_tit_tat.pk', 'wb') as f:
